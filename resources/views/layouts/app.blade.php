    ...
    <div id="app" class="allButFooter">
        <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
            <div class="container-fluid">
                ...
                style="background: url('{{ asset('storage/unimas-logo.png') }}') center / cover; height: 50px; width: 50px;"></span>
                          <a class="navbar-brand" href="{{ url('/home') }}">
                    FYP System{{-- {{ config('app.name', 'Laravel') }} --}}
                </a>
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <div class="collapse navbar-collapse" id="navcol-1">
                            <ul class="navbar-nav me-auto">
                                ...
                                {{-- <li class="nav-item"><a class="nav-link {{ Route::is('form') ? 'active' : '' }}" href="{{route('form')}}">Form</a></li> --}}
                                @if(Auth::user()->role=='1')
                                <li class="nav-item"><a class="nav-link {{ Route::is('showform') ? 'active' : '' }}" href="{{route('showform')}}">All Forms</a></li>
                                @endif
                                {{-- <li class="nav-item"><a class="nav-link {{ Route::is('profile') ? 'active' : '' }}" href="{{route('profile')}}">Profile</a></li> --}}
                            </ul>
                        </div>
                        @endguest
                    </ul>
